...
购热销商品</em>
					...
					<div class="clearfix choose">{{specificationItems}}
							...
							<#list specificationList as spec>
                                <dl>
									...
									<#list spec.attributeValue as item>
										<dd><a class="{{isSelected('${spec.attributeName}','${item}')?'selected':''}}" href="javascript:;" ng-click="selectSpecification('${spec.attributeName}','${item}')">${item}
