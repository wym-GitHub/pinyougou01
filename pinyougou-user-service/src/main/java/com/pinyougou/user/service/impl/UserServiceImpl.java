...
public class UserServiceImpl implements UserService {
	...
	public void add(TbUser user) {
		...
		//密码加密,用到了org.apache.commons.codec.digest.DigestUtils工具类
	...
	public void createSmsCode(String phone) {
		...
		//存入缓存中
		redisTemplate.boundHashOps("smscode").put(phone, code);//以手机号为小key存入缓存中
...
//
					...
					mapMessage.setString("param", s);//验证码
